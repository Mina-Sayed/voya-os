-- Voya OS: controlled property-owner creation with idempotency and audit.

ALTER TABLE public.property_owners
  ADD COLUMN idempotency_key text;

ALTER TABLE public.property_owners
  ADD CONSTRAINT property_owners_idempotency_key_unique
...
REVOKE ALL ON FUNCTION public.create_property_owner(uuid, text, text, uuid) FROM PUBLIC;
