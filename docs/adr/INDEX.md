...
| [ADR-020](./ADR-020-ai-confirmed-data-entry.md) | Human-confirmed AI data entry | Proposed for implementation review | Tenant-scoped drafts, private image intake, and deterministic confirmation |
