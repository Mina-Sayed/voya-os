...
}: Readonly<{ agents: readonly AgentDefinition[]; runs: readonly AiRunItem[]; requestRun: AiAction; dataEntryDrafts?: readonly DataEntryDraftSummary[]; dataEntryReviews?: readonly import("./data-entry-review").DataEntryDraftReview[]; createDataEntryDraft?: DataEntryAction; confirmDataEntryDraft?: DataEntryAction; rejectDataEntryDraft?: DataEntryAction; submitDataEntryDraft?: DataEntryAction }>) {
