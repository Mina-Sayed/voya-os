...
function BookingCard({ booking, requestApproval, confirmBooking, recordStay, canOperateStay, canApprove }: Readonly<{ booking: BookingDraftListItem; requestApproval: BookingLifecycleAction; confirmBooking: BookingLifecycleAction; recordStay: BookingStayAction; canOperateStay: boolean; canApprove: boolean }>) {
